(defproject org.xilk/lein-template.xp-web-app "20220615-10"
  :description (str "A Leiningen template that creates experimental web app "
                    ...
                    "via smooth development patterns and tools.")
  :url "https://github.com/xilk-org/xilk-xp-web-app-template"
